...
<table class="table table-bordered">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a class="text-warning" href="{{ .Site.BaseURL }}/docs/{{ .Site.Params.docs_version }}/layout/grid/">Only grid system</a></td>
      <td class="bg-light text-muted">Not included</td>
      <td class="bg-light text-muted">Not included</td>
      <td><a class="text-warning" href="{{ .Site.BaseURL }}/docs/{{ .Site.Params.docs_version }}/utilities/flex/">Only flex utilities</a></td>
    </tr>
    <tr>
      <th scope="row">
      ...
      <td class="bg-light text-muted">Not included</td>
      <td><a class="text-warning" href="{{ .Site.BaseURL }}/docs/{{ .Site.Params.docs_version }}/content/reboot/">Only Reboot</a></td>
      <td class="bg-light text-muted">Not included</td>
      <td class="bg-light text-muted">Not included</td>
    </tr>
  </tbody>
