$(function () {
  ...
  QUnit.test('should enforce focus', function (assert) {
    ...
    var spyDocOff = sinon.spy(EventHandler, 'off')
    var spyDocOn = sinon.spy(EventHandler, 'on')

    $modal.one('shown.bs.modal', function () {
      assert.ok(spy.called, '_enforceFocus called')
      assert.ok(spyDocOff.withArgs(document, 'focusin.bs.modal'))
      assert.ok(spyDocOn.withArgs(document, 'focusin.bs.modal'))
