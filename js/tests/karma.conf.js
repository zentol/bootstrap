...
const jqueryFile = process.env.USE_OLD_JQUERY ? 'https://code.jquery.com/jquery-1.9.1.min.js' : 'site/static/docs/4.1/assets/js/vendor/jquery-slim.min.js'
...
if (bundle) {
  ...
  files = files.concat([
    'site/static/docs/4.1/assets/js/vendor/jquery-slim.min.js',
    'js/dist/util.js',
    'js/dist/tooltip.js',
